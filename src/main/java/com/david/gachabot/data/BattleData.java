...
public class BattleData {
	...
	private boolean faint1;
	private boolean faint2;
	...
	public BattleData(UserData user1, int user1Out, UserData user2, int user2Out, Message m) {
		...
		for(Integer id : user1.getTeam()) {
			...
			user1Stats.put(data, new int[] {data.getHP(), data.getDefense(), data.getAttack()});
		}
		...
		for(Integer id : user2.getTeam()) {
			...
			user2Stats.put(data, new int[] {data.getHP(), data.getDefense(), data.getAttack()});
		}
	}
	...
	public boolean isUser1Fainted() {
		return faint1;
	}
	
	public boolean isUser2Fainted() {
		return faint2;
	}
	...
	public void setUser1Faint(boolean f) {
		faint1 = f;
	}
	
	public void setUser2Faint(boolean f) {
		faint2 = f;
	}
